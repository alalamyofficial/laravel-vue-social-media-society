    ...
    <div>
        ...
        >
            <div id="app" class="bg-white w-full shadow rounded-lg p-5 mb-2">
                ...
                <!-- <input class="mt-2 mb-1" type="file" name="" id=""> -->
                            ...
                            >
                                <div class="flex mr-5">
                                    ...
                                    <div class="flex mb-2 mr-1">
                                        <img :src="post.user.avatar" width="35px" class="rounded-circle mt-1" alt="sunil" />
                                        <a
                                            class="ml-1 mt-2"
                                    ...
                                    <div class="mx-6 mt-2" v-if="post.user.id == user_id">
...
export default {
    ...
    methods: {
        ...
        postImageModal(id) {
            axios.get("/posts/images/" + id).then(response => {
                console.log(response);
                this.id = response.data.id;
                this.images = response.data.images;
                //   this.post_images = response.data
        ...
        emojiarea() {
            var emojiSelector = document.querySelector("#myTextArea");

            emojiSelector.emojioneArea();
        }
    }
};
</script>
